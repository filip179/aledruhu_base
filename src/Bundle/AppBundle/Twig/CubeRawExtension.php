...
class CubeRawExtension extends NullExtension {
    public function getFilters()
    {
        return [
            new \Twig_SimpleFilter('cubeRaw', [$this, 'getXssCLean'], ['is_safe' => ['html']]),
        ];
    }

    public function getXssCLean($data)
    {
